  ...
  return (
    <div className="serviceArea">
      ...
      <p>
        ...
        It isn't easy to take care of all the areas of banner designing. So to ensure that you prepare the best banner, hire an expert. No one other than the AIIDL Technologies can be your first choice when you match our services and rates with other service providers.
      </p>
